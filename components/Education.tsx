      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
              <h3 className="content-title text-2xl font-bold text-gray-900 dark:text-white mb-2">
                B.S. (Honors) Computer Science
              </h3>
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-2">
                University of Prince Edward Island
              </p>
              <p className="meta text-gray-600 dark:text-gray-400">
                Minor: Physics
              </p>
            </div>
            <div className="mt-4 md:mt-0 text-right">
              <span className="meta text-gray-600 dark:text-gray-400">
          ...
          <div className="border-l-4 border-blue-500 pl-6">
            <h4 className="subtitle text-lg font-semibold text-gray-900 dark:text-white mb-3">
              Honors Thesis
            </h4>
